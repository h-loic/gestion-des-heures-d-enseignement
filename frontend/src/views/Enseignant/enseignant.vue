                    ...
                    <table class="table">
                        ...
                        <tr v-for="ens in enseignants" v-bind:key="ens._id">
                            ...
                            <td>
                                ...
                                <a v-on:click="deleteEnseignant(ens._id)" class="text-danger" style="margin-left: auto;margin-right: auto"><svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    export default {
        ...
        methods: {
            async deleteEnseignant(id){
                await EnseignantService.deleteEnseignant(id).then( async res =>{
                    if (res.data.err === 1){
